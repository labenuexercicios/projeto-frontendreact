  ...
  return (
    <div className="flex flex-col items-center">
      <div className="w-screen  lg:flex lg:justify-end">
        <input
          className="z-20 w-full lg:w-1/6 relative px-2 focus:outline-none border-b py-2 lg:fixed lg:top-2 lg:right-36 "
          placeholder="Buscar"
        ></input>
        <FiSearch className="absolute right-2 top-[76px] lg:top-6 lg:right-40 lg:fixed z-20" />
      </div>
      <img
